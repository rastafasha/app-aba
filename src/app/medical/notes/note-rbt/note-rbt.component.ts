...
export class NoteRbtComponent {
  ...
  public selectedValueTimeIn!: string;
  public selectedValueTimeOut!: string;
  public selectedValueTimeIn2!: string;
  public selectedValueTimeOut2!: string;
  ...
  selectMaladaptive(event:any){debugger
    event = this.selectedValueMaladaptive;
    this.specialistData(this.selectedValueMaladaptive);
